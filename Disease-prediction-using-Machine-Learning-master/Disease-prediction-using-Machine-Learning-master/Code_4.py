...
def randomforest():
    ...
    acc = print(f"This is the accuracy: {accuracy_score(y_test, y_pred)}")
...
# w2 = Label(root, justify=LEFT, text="A Project by Rounak", fg="white", bg="blue")
...
destreeLb = Label(root, text="RandomForest", fg="Black", bg="Sea green")
...
NameEn = Entry(root, textvariable=Name, bg="cyan2")
...
rnf = Button(root, text="Randomforest", command=randomforest, bg="magenta4", fg="black")
rnf.grid(row=8, column=3, padx=100)


t2 = Text(root, height=1, width=40, bg="Coral1", fg="black")
